    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:560px;width:100%;">
        ...
        <tr><td style="padding:40px;">
          ...
          <a href="https://www.everstead.care/dashboard?tab=settings" style="display:inline-block;background:#2d5082;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:9999px;font-size:14px;margin-bottom:24px;">${t('cxExportCta')}</a>
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:560px;width:100%;">
        ...
        <tr><td style="padding:40px;">
          ...
          <a href="${process.env.VITE_APP_URL}/dashboard" style="display:inline-block;background:#2d5082;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:9999px;font-size:15px;">${t('teCta')}</a>
        </td></tr>
        <tr><td style="padding:24px 40px;border-top:1px solid #e8e5e0;">
