    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:560px;width:100%;">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="margin:0 0 16px;color:#4a5568;font-size:16px;line-height:1.6;">You've given ${recipientName || recipientEmail} an Everstead <strong>${planName}</strong> plan for <strong>${yearsLabel}</strong> — that's a genuinely thoughtful gift.</p>
