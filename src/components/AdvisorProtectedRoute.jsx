    ...
    return (
      <div className="min-h-screen bg-stone-50 flex items-center justify-center px-6">
        <div className="max-w-md w-full rounded-[2rem] border border-stone-200 bg-white p-10 text-center shadow-sm space-y-5">
          ...
          <div>
            <h1 className="font-display text-2xl font-light text-navy-950 mb-2">Advisor plan required</h1>
            <p className="text-sm text-stone-500 leading-relaxed">
              The Advisor Portal is only available on the Advisor plan. You're currently on the{' '}
