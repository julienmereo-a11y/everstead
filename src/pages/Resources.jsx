...
const sections = {
  blog: {
    ...
    posts: [
      ...
      {
        slug: 'how-to-write-a-letter-of-wishes',
      ...
      {
        slug: 'where-to-keep-important-documents',
        ...
        body: [
          ...
          { type: 'checklist', heading: 'Property and finance', items: ['Property deeds or Land Registry title number', 'Mortgage and loan paperwork', 'Bank, savings, and investment account details', 'Pension and insurance policy documents'] },
          { type: 'checklist', heading: 'Day-to-day and digital', items: ['Utility and subscription accounts', 'A list of online accounts and where their access is stored', 'Funeral plan or wishes, if you have them'] },
          { type: 'heading', text: 'Your storage options, with pros and cons' },
      ...
      {
        slug: 'notaires-conseillers-clients-prepares',
        title: 'Notaires, conseillers : et si vos clients arrivaient préparés ?',
        date: 'September 2026',
        tag: 'Professionnels',
        lang: 'fr',
        desc: "Le premier rendez-vous part trop souvent en reconstitution d'inventaire, et les successions en semaines de recherche. Ce qu'un coffre numérique partagé change pour les notaires, avocats et conseillers en gestion de patrimoine, et pour leurs clients.",
        readTime: '7 min de lecture',
        body: [
          { type: 'intro', text: "Vous le vivez à chaque premier rendez-vous : le client arrive avec une pochette de relevés dépareillés, des souvenirs approximatifs de ses contrats, et aucune liste de ses comptes. La première heure, facturée ou non, part en reconstitution. Et le jour où survient un décès, ce sont ses proches qui appellent votre étude ou votre cabinet, en plein deuil, pour poser des questions auxquelles personne n'a préparé de réponse. Cet article s'adresse aux notaires, avocats et conseillers en gestion de patrimoine : il examine ce que coûte un patrimoine non documenté, à vos clients comme à votre pratique, et comment un coffre numérique partagé change la nature du premier rendez-vous." },
          { type: 'toc', items: ["Le paradoxe du premier rendez-vous", "Ce que coûte un patrimoine non documenté", "La transmission ne commence pas à la succession", "Un dossier client qui reste à jour entre deux rendez-vous", "Comment l'intégrer à votre pratique"] },
          { type: 'heading', text: "Le paradoxe du premier rendez-vous" },
          { type: 'text', text: "Votre expertise porte sur les décisions : structurer une transmission, arbitrer entre donation et assurance-vie, rédiger un mandat de protection future. Mais avant de décider, il faut savoir ce qui existe. Et c'est là que le temps se perd. Le client ne sait plus dans quelle banque dort son ancien PEL, a oublié le contrat de prévoyance souscrit par son employeur d'il y a quinze ans, et n'a jamais fait la liste de ses comptes en ligne." },
          { type: 'text', text: "Ce n'est la faute de personne. Une vie patrimoniale se construit par couches, sur des décennies, et personne ne tient de registre. Le résultat est pourtant le même dans chaque dossier : l'inventaire consomme le temps que vous auriez consacré au conseil." },
          { type: 'heading', text: "Ce que coûte un patrimoine non documenté" },
          { type: 'text', text: "Pour les familles, le coût est d'abord humain : des semaines à écrire aux banques, à chercher des contrats, à reconstituer une vie administrative pendant le deuil. Il est aussi financier. Les avoirs que personne ne réclame finissent en déshérence : la loi Eckert impose depuis 2016 le transfert des comptes inactifs et des contrats d'assurance-vie non réclamés à la Caisse des Dépôts, et le dispositif Ciclade en restitue chaque année une petite partie seulement. Plusieurs milliards d'euros y attendent leurs bénéficiaires, précisément parce qu'aucune liste n'existait au bon moment." },
          { type: 'text', text: "Pour le professionnel, le coût est plus discret mais bien réel : des successions qui s'éternisent faute de pièces, des héritiers qu'il faut relancer, et une relation qui s'arrête souvent avec la génération qui l'avait nouée. Les enfants du client ne vous connaissent pas ; le premier contact a lieu au pire moment, dans l'urgence d'une succession désorganisée." },
          { type: 'heading', text: "La transmission ne commence pas à la succession" },
          { type: 'text', text: "Le paradoxe de la gestion de patrimoine est que la transmission, son moment le plus important, est aussi le moins préparé relationnellement. Le professionnel qui n'a jamais rencontré les enfants de son client avant le décès découvre des héritiers pressés, parfois en désaccord, et rarement enclins à prolonger une relation qu'ils n'ont pas choisie." },
          { type: 'text', text: "Anticiper change la donne : quand le client a désigné ses personnes de confiance, expliqué où tout se trouve et introduit son notaire ou son conseiller auprès de ses proches, la succession devient la continuation d'une relation plutôt que son point final. C'est vrai humainement, et c'est vrai commercialement." },
          { type: 'heading', text: "Un dossier client qui reste à jour entre deux rendez-vous" },
          { type: 'text', text: "C'est ici qu'Everstead intervient. Everstead est un coffre numérique dans lequel votre client recense ses comptes, dépose ses documents (testament, mandat de protection future, contrats) et écrit ses volontés, puis décide précisément qui peut voir quoi, et à quel moment : un accès complet pour son conjoint, un document pour un enfant, une enveloppe scellée pour son notaire, qui ne s'ouvrira que le moment venu." },
          { type: 'text', text: "Pour les professionnels, Everstead Pro ajoute un portail dédié : vous invitez vos propres clients, suivez leur niveau de préparation d'un coup d'œil sur l'ensemble de votre portefeuille, et disposez, avec leur accord, d'une synthèse imprimable de leur situation, comptes, documents, instructions et personnes de confiance. Le client reste propriétaire de ses données et maître des accès ; Everstead ne délivre aucun conseil juridique ni financier, ce rôle est le vôtre." },
          { type: 'list', heading: "Concrètement, ce que cela change dans votre pratique :", items: ["Le premier rendez-vous commence sur un inventaire déjà constitué, pas sur une pochette de relevés", "Vous voyez quels clients sont préparés et lesquels ont besoin d'une relance, sans les appeler un par un", "Le jour d'une succession, la synthèse existe déjà, au lieu de semaines de reconstitution", "Vos coordonnées figurent dans le coffre du client : ses proches savent qui appeler, et vous rencontrez la génération suivante avant la transmission", "Les données sont chiffrées et hébergées en Europe, avec un contrôle des accès par personne et par document"] },
          { type: 'heading', text: "Comment l'intégrer à votre pratique" },
          { type: 'text', text: "La mise en place ne demande ni installation ni changement d'outils : vous invitez vos clients depuis le portail, chacun crée son coffre gratuitement et le remplit à son rythme, guidé par un score de préparation. Beaucoup de professionnels commencent par deux ou trois dossiers, souvent à l'occasion d'un événement naturel, une donation, un mandat, une mise à jour de clause bénéficiaire, avant d'en faire un réflexe de leur pratique." },
          { type: 'text', text: "Everstead est disponible sur le web, iOS et Android, en France et au Royaume-Uni, avec le vocabulaire juridique propre à chaque pays. Le produit est construit pour le droit français, pas traduit depuis l'anglais." },
          { type: 'note', text: "Ces informations sont générales et ne constituent pas un conseil juridique ou financier. Everstead est un outil d'organisation et de partage sécurisé ; le conseil reste l'affaire des professionnels." },
          { type: 'related', heading: "À lire aussi", links: [{ label: "Le mandat de protection future, expliqué simplement", href: "/resources/blog/mandat-protection-future" }, { label: "Assurance-vie et succession : ce que vos bénéficiaires doivent savoir", href: "/resources/blog/assurance-vie-succession" }, { label: "Testament et réserve héréditaire : ce que vous pouvez (vraiment) transmettre", href: "/resources/blog/testament-reserve-hereditaire" }] },
          { type: 'cta', text: "Vos clients méritent d'arriver préparés, et vos successions de commencer sur une synthèse plutôt que sur une recherche. Découvrez Everstead Pro lors d'un échange de vingt minutes : réservez un créneau depuis la page Contact." },
        ],
      },
      {
        slug: 'deces-comptes-bancaires-france',
        title: "Décès et comptes bancaires : ce que fait la banque, ce que peuvent vos proches",
        date: 'September 2026',
        tag: 'Banque et succession',
        lang: 'fr',
        desc: "Compte bloqué, compte joint, procurations, frais d'obsèques, avoirs oubliés : ce qui se passe concrètement dans les banques après un décès en France, et comment épargner des semaines de démarches à vos proches.",
        readTime: '7 min de lecture',
        body: [
          { type: "intro", text: "Au décès d'un proche, la banque est souvent le premier guichet auquel la famille se heurte. Les comptes se bloquent, les procurations s'éteignent, et chaque établissement demande ses propres justificatifs. Rien de tout cela n'est une malveillance : ce sont des règles de protection. Mais quand personne ne sait combien de banques le défunt fréquentait, ces règles se transforment en semaines de recherche. Voici ce qui se passe concrètement, et ce que vous pouvez préparer dès aujourd'hui." },
          { type: 'toc', items: ["Ce que la banque fait dès qu'elle apprend le décès", "Le cas du compte joint", "Les frais d'obsèques", "Débloquer les comptes : attestation ou notaire", "Les comptes que personne ne réclame", "Ce que vous pouvez préparer dès maintenant"] },
          { type: "heading", text: "Ce que la banque fait dès qu'elle apprend le décès" },
          { type: "text", text: "Dès qu'elle est informée du décès, généralement par la famille ou par le notaire, la banque bloque les comptes individuels du défunt : plus de retraits, plus de virements, plus de paiements par carte. Les procurations données de son vivant cessent immédiatement, même au conjoint. Les prélèvements en cours sont interrompus ou rejetés, ce qui explique qu'il faille prévenir rapidement les organismes qui prélevaient sur ce compte." },
          { type: "text", text: "C'est aussi pour cela que chaque banque doit être prévenue individuellement. Il n'existe pas de guichet unique : si le défunt avait des comptes dans trois établissements, il faudra trois courriers, trois actes de décès, trois dossiers. D'où l'importance, en amont, d'une liste." },
          { type: "heading", text: "Le cas du compte joint" },
          { type: "text", text: "Le compte joint fait exception : sauf opposition, il continue de fonctionner au nom du cotitulaire survivant, qui peut poursuivre les opérations courantes. La moitié du solde est en principe réputée appartenir à la succession, ce qui sera régularisé lors du règlement. Attention en revanche au compte individuel du conjoint survivant : si les ressources du ménage arrivaient sur le compte du défunt, le survivant peut se retrouver temporairement à court de liquidités. C'est une situation fréquente, et évitable." },
          { type: "heading", text: "Les frais d'obsèques" },
          { type: "text", text: "La loi permet à la personne qui a réglé les obsèques d'obtenir, sur présentation de la facture, un prélèvement sur les comptes du défunt dans la limite d'un plafond fixé par arrêté, de l'ordre de quelques milliers d'euros, sous réserve que le solde le permette. C'est une soupape utile, mais elle suppose de savoir dans quelle banque demander. Vérifiez le plafond en vigueur au moment des démarches : il est révisé périodiquement." },
          { type: "heading", text: "Débloquer les comptes : attestation ou notaire" },
          { type: "text", text: "Pour les successions modestes, la banque peut accepter une attestation signée de l'ensemble des héritiers, accompagnée des justificatifs d'usage, pour clôturer les comptes et verser les fonds. Au-delà d'un certain montant, ou dès que la succession comporte un testament ou un bien immobilier, l'acte de notoriété établi par le notaire devient la clé : c'est lui qui prouve la qualité d'héritier auprès des établissements." },
          { type: 'list', heading: "Les documents que les banques demandent le plus souvent :", items: ["L'acte de décès", "Une pièce d'identité de l'héritier ou du demandeur", "L'acte de notoriété, ou l'attestation des héritiers pour les petites successions", "Le livret de famille", "La facture des obsèques, pour le prélèvement dédié"] },
          { type: "heading", text: "Les comptes que personne ne réclame" },
          { type: "text", text: "Quand un compte n'est pas réclamé, la loi Eckert impose à la banque de le considérer comme inactif, puis de transférer les fonds à la Caisse des Dépôts, où le dispositif Ciclade permet aux ayants droit de les rechercher. Des milliards d'euros y dorment, faute d'une simple liste établie du vivant du titulaire. Un compte oublié n'est pas perdu pour toujours, mais il est perdu pour longtemps : la démarche Ciclade suppose déjà de soupçonner l'existence du compte." },
          { type: "heading", text: "Ce que vous pouvez préparer dès maintenant" },
          { type: 'list', heading: "Une heure aujourd'hui épargne des semaines à vos proches :", items: ["Listez vos banques et vos comptes, sans les mots de passe : l'établissement et le type de compte suffisent", "Signalez les comptes joints et les procurations existantes", "Vérifiez que le conjoint survivant disposerait de liquidités à son nom", "Indiquez où trouver vos contrats d'assurance-vie, qui suivent un circuit distinct de la succession", "Dites à vos personnes de confiance où cette liste se trouve"] },
          { type: "text", text: "C'est exactement ce pour quoi Everstead existe : vos comptes recensés, vos documents à l'abri, et des personnes de confiance qui sauront où chercher, avec les accès que vous aurez décidés, ni plus, ni moins." },
          { type: "note", text: "Ces informations sont générales et ne constituent pas un conseil juridique. Les plafonds et seuils évoqués sont fixés par les textes et révisés périodiquement ; votre notaire ou votre banque vous indiqueront les montants en vigueur." },
          { type: 'related', heading: "À lire aussi", links: [{ label: "Assurance-vie et succession : ce que vos bénéficiaires doivent savoir", href: "/resources/blog/assurance-vie-succession" }, { label: "Testament et réserve héréditaire : ce que vous pouvez (vraiment) transmettre", href: "/resources/blog/testament-reserve-hereditaire" }, { label: "Le mandat de protection future, expliqué simplement", href: "/resources/blog/mandat-protection-future" }] },
          { type: "cta", text: "La liste de vos comptes est le premier cadeau que vous pouvez faire à vos proches. Everstead la garde en lieu sûr, à jour, et la partage au bon moment avec les bonnes personnes. L'inscription est gratuite." },
        ],
      },
      {
        slug: 'vie-numerique-succession',
        title: "Que devient votre vie numérique après vous ?",
        date: 'September 2026',
        tag: 'Vie numérique',
        lang: 'fr',
        desc: "E-mails, photos dans le cloud, réseaux sociaux, abonnements : ce que le droit français prévoit pour vos données après le décès, ce que proposent les grandes plateformes, et comment éviter que des pans entiers de votre vie ne deviennent inaccessibles.",
        readTime: '7 min de lecture',
        body: [
          { type: "intro", text: "Nos parents laissaient des albums photo et des relevés papier. Nous laisserons des comptes en ligne : la boîte mail qui centralise tout, vingt ans de photos dans le cloud, des abonnements qui continuent de prélever, des profils sociaux qui restent ouverts. Or presque tout cela est protégé par des mots de passe que personne d'autre ne connaît, et par des conditions d'utilisation qui n'ont pas prévu votre absence. Voici ce que dit le droit français, ce que proposent les plateformes, et surtout ce que vous pouvez organiser dès maintenant." },
          { type: 'toc', items: ["Le problème : des vies entières derrière des mots de passe", "Ce que prévoit le droit français", "Ce que proposent les grandes plateformes", "Les abonnements qui continuent de prélever", "Mots de passe : ce qu'il ne faut pas faire", "Organiser sa vie numérique, pas à pas"] },
          { type: "heading", text: "Le problème : des vies entières derrière des mots de passe" },
          { type: "text", text: "La boîte mail est devenue le trousseau central de nos vies : c'est elle qui reçoit les relevés, réinitialise les mots de passe, confirme les abonnements. Inaccessible, elle verrouille tout le reste. Et contrairement à un tiroir, un compte en ligne ne se force pas : les plateformes appliquent leurs règles, souvent pensées dans un autre droit que le nôtre, et les proches se heurtent à des procédures longues, en anglais, avec des issues incertaines." },
          { type: "heading", text: "Ce que prévoit le droit français" },
          { type: "text", text: "La France est l'un des rares pays à avoir légiféré : depuis la loi pour une République numérique de 2016, toute personne peut donner des directives sur le sort de ses données après son décès, directives générales ou particulières, et désigner une personne chargée de les faire exécuter. À défaut, les héritiers disposent de droits limités : ils peuvent notamment demander la clôture des comptes et s'opposer à la poursuite du traitement des données, mais pas librement accéder à tout." },
          { type: "text", text: "Autrement dit, le droit vous donne la main, mais seulement si vous l'avez prise de votre vivant. Sans directive, vos proches dépendront des politiques de chaque plateforme et de démarches au cas par cas." },
          { type: "heading", text: "Ce que proposent les grandes plateformes" },
          { type: "text", text: "Certains services ont prévu le sujet : Google permet de désigner des contacts qui recevront vos données si le compte devient inactif, Facebook propose de transformer un profil en compte de commémoration géré par un contact légataire, Apple permet de désigner des contacts d'héritage numérique. Ces dispositifs sont utiles, mais ils se configurent service par service, de votre vivant, et presque personne ne le fait. Les autres plateformes, la majorité, n'offrent qu'une procédure de clôture sur justificatifs." },
          { type: "heading", text: "Les abonnements qui continuent de prélever" },
          { type: "text", text: "Streaming, presse en ligne, stockage, logiciels : les abonnements ne s'arrêtent pas d'eux-mêmes. Tant que le compte bancaire fonctionne, ils prélèvent ; quand il est bloqué, ils passent en impayé et relancent. Pour des proches qui ignorent jusqu'à l'existence de ces services, chaque prélèvement est une enquête. Une simple liste des abonnements, avec le service et le moyen de paiement associé, transforme des mois d'agacement en une matinée de résiliations." },
          { type: "heading", text: "Mots de passe : ce qu'il ne faut pas faire" },
          { type: "text", text: "La tentation est d'écrire tous ses mots de passe dans un carnet ou un fichier partagé. C'est une double erreur : de votre vivant, c'est une faille de sécurité béante ; et après, se connecter au compte d'un défunt avec ses identifiants, même en famille, se situe dans une zone grise vis-à-vis des conditions d'utilisation et de la loi. La bonne approche est différente : recensez ce qui existe, sans les secrets. Vos proches n'ont pas besoin de vos mots de passe : ils ont besoin de savoir que le compte existe, chez qui, et à quel nom, pour engager les bonnes démarches." },
          { type: "heading", text: "Organiser sa vie numérique, pas à pas" },
          { type: 'list', heading: "Dans l'ordre, et sans y passer plus d'une soirée :", items: ["Listez vos comptes essentiels : e-mail principal, banque en ligne, impôts, cloud photo, réseaux sociaux", "Configurez les dispositifs d'héritage là où ils existent (compte inactif, contact légataire, héritage numérique)", "Listez vos abonnements payants et le moyen de paiement associé", "Rédigez vos volontés : ce qui doit être conservé, transmis, ou supprimé", "Confiez cette liste à un endroit sûr, accessible à vos personnes de confiance le moment venu, et jamais en clair dans un tiroir"] },
          { type: "text", text: "Everstead a été conçu pour exactement cela : un coffre chiffré où votre vie numérique est recensée sans exposer vos secrets, des personnes de confiance qui n'accèdent qu'à ce que vous avez décidé, et le moment venu seulement. De votre vivant, rien ne circule ; après, vos proches savent où chercher au lieu de deviner." },
          { type: "note", text: "Ces informations sont générales et ne constituent pas un conseil juridique. Les dispositifs cités (directives sur les données, contacts d'héritage des plateformes) évoluent ; vérifiez leurs modalités au moment où vous les configurez." },
          { type: 'related', heading: "À lire aussi", links: [{ label: "Décès et comptes bancaires : ce que fait la banque, ce que peuvent vos proches", href: "/resources/blog/deces-comptes-bancaires-france" }, { label: "Le mandat de protection future, expliqué simplement", href: "/resources/blog/mandat-protection-future" }, { label: "Assurance-vie et succession : ce que vos bénéficiaires doivent savoir", href: "/resources/blog/assurance-vie-succession" }] },
          { type: "cta", text: "Votre vie numérique mérite le même soin que vos papiers. Everstead recense vos comptes et vos volontés dans un coffre chiffré, partagé au bon moment avec les bonnes personnes. L'inscription est gratuite." },
        ],
      },
      {
        slug: 'que-faire-apres-un-deces-france',
        title: "Que faire après un décès en France : le guide pas à pas",
        date: 'September 2026',
        tag: 'Démarches',
        lang: 'fr',
        desc: "Constat, déclaration en mairie, obsèques, banques, organismes, notaire et succession : les démarches après un décès en France, dans l'ordre où elles se présentent réellement, et les délais à connaître.",
        readTime: '8 min de lecture',
        body: [
          { type: "intro", text: "Quand un proche meurt, tout arrive en même temps : le chagrin, le choc, et un monde administratif qui attend des décisions dans des délais que personne ne connaît à l'avance. Ce guide déroule les démarches après un décès en France, dans l'ordre où elles se présentent réellement, des premières heures jusqu'à la succession. Vous n'avez pas besoin de tout lire aujourd'hui : prenez l'étape où vous en êtes, le reste attendra." },
          { type: 'toc', items: ["Les premières heures : constat et déclaration", "Les premiers jours : les obsèques", "Prévenir les banques", "Prévenir les organismes", "La succession : notaire, acte de notoriété, délais", "Assurance-vie et avoirs oubliés", "Et après"] },
          { type: "heading", text: "Les premières heures : constat et déclaration" },
          { type: "text", text: "La première démarche est le constat du décès par un médecin, qui établit le certificat de décès. À domicile, appelez le médecin traitant ou le 15 ; à l'hôpital ou en EHPAD, l'établissement s'en charge et guide les proches. En cas de décès soudain, accidentel ou inexpliqué, la police ou la gendarmerie interviennent : c'est une procédure normale, pas une suspicion." },
          { type: "text", text: "Le décès doit ensuite être déclaré à la mairie du lieu de décès sous 24 heures. En pratique, les pompes funèbres accomplissent cette formalité pour la famille. Demandez d'emblée plusieurs copies de l'acte de décès : chaque banque, chaque assurance, chaque organisme en exigera une." },
          { type: "heading", text: "Les premiers jours : les obsèques" },
          { type: "text", text: "Les obsèques ont lieu entre 24 heures et 6 jours ouvrables après le décès, sauf dérogation préfectorale. Avant d'organiser quoi que ce soit, vérifiez si le défunt avait exprimé des volontés : un contrat obsèques, des souhaits écrits, une position sur le don d'organes. Les devis des pompes funèbres sont obligatoires et normalisés, ce qui permet de comparer sereinement, même dans l'urgence." },
          { type: "heading", text: "Prévenir les banques" },
          { type: "text", text: "Dès qu'elle est informée, la banque bloque les comptes individuels du défunt et met fin aux procurations. Le compte joint, lui, continue de fonctionner pour le cotitulaire survivant. La personne qui a réglé les obsèques peut en obtenir le remboursement sur les comptes du défunt, sur facture et dans la limite d'un plafond fixé par arrêté. Il n'existe pas de guichet unique : chaque établissement doit être prévenu individuellement, d'où l'importance de savoir où le défunt avait des comptes." },
          { type: "heading", text: "Prévenir les organismes" },
          { type: 'list', heading: "Dans le mois qui suit, selon la situation :", items: ["L'employeur, ou France Travail pour un demandeur d'emploi", "Les caisses de retraite, de base et complémentaires : la pension de réversion du conjoint n'est pas automatique, il faut la demander", "La CPAM et la mutuelle : un capital décès peut exister selon la situation", "La CAF, les impôts, les assurances, le bailleur ou le syndic", "Les fournisseurs d'énergie, de téléphonie et les abonnements"] },
          { type: "text", text: "L'ensemble des démarches officielles est récapitulé sur service-public.fr, rubrique Décès. Avancez organisme par organisme, une copie d'acte de décès à la main : personne ne fait tout en une semaine, et personne ne vous le demande." },
          { type: "heading", text: "La succession : notaire, acte de notoriété, délais" },
          { type: "text", text: "Le notaire est en pratique incontournable dès qu'il existe un testament, un bien immobilier, un contrat de mariage ou des montants significatifs. Il interroge le fichier central des dispositions de dernières volontés pour retrouver un éventuel testament, et établit l'acte de notoriété, le document qui prouve la qualité d'héritier auprès des banques et des organismes." },
          { type: "text", text: "Un délai à connaître : la déclaration de succession doit être déposée aux impôts dans les 6 mois du décès en métropole. Le conjoint survivant et le partenaire de PACS sont exonérés de droits de succession ; pour les autres héritiers, abattements et barèmes s'appliquent, et c'est précisément le terrain du notaire." },
          { type: "heading", text: "Assurance-vie et avoirs oubliés" },
          { type: "text", text: "L'assurance-vie suit un circuit distinct de la succession : elle revient aux bénéficiaires désignés dans la clause du contrat. Si vous ignorez si un contrat existe, la démarche AGIRA est gratuite et interroge l'ensemble des assureurs. Quant aux comptes bancaires jamais réclamés, la loi Eckert impose leur transfert à la Caisse des Dépôts, où le service Ciclade permet de les rechercher. Des sommes considérables y dorment, faute d'une simple liste établie du vivant du titulaire." },
          { type: "heading", text: "Et après" },
          { type: "text", text: "Quand les démarches retombent, le deuil, lui, continue. Ne restez pas seul : votre médecin traitant peut vous orienter vers un accompagnement, et des associations spécialisées existent partout en France. Et quand vous vous en sentirez la force, une dernière démarche a du sens : faire pour vos proches ce que vous auriez aimé trouver, une liste claire de vos comptes, vos documents à l'abri, et des personnes de confiance qui sauront où chercher." },
          { type: "note", text: "Ces informations sont générales et ne constituent pas un conseil juridique ou fiscal. Les délais et plafonds cités sont fixés par les textes et peuvent évoluer ; votre notaire et service-public.fr font foi." },
          { type: 'related', heading: "À lire aussi", links: [{ label: "Décès et comptes bancaires : ce que fait la banque, ce que peuvent vos proches", href: "/resources/blog/deces-comptes-bancaires-france" }, { label: "Assurance-vie et succession : ce que vos bénéficiaires doivent savoir", href: "/resources/blog/assurance-vie-succession" }, { label: "Que devient votre vie numérique après vous ?", href: "/resources/blog/vie-numerique-succession" }] },
          { type: "cta", text: "Pour avancer pas à pas, notre liste interactive des démarches est gratuite, imprimable et pensée pour la France : everstead.care/fr/apres-un-deces. Et pour les questions propres à votre situation, notre assistant gratuit vous répond à tout moment : everstead.care/fr/assistant-apres-deces." },
        ],
      },
    ],
  },
