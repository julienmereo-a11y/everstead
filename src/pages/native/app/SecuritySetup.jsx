...
import { setPasscode, setBiometricEnabled, markSetupDone, biometricAvailable } from '../../../components/native/appLock'
...
export default function SecuritySetup({ onDone }) {
  const [step, setStep] = useState('pin')      // 'pin' | 'confirm' | 'bio'
  ...
  const skip = async () => { setBusy(true); await markSetupDone(); onDone() }
