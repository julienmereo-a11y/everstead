  ...
  return (
    ...
    <div className="min-h-screen bg-stone-50 flex flex-col">
      ...
      <main ref={mainRef} className="flex-1 overflow-auto flex flex-col min-w-0 pb-24" style={{ backgroundColor: '#f8f7f5' }} aria-label={t('shell.mainContent')}>
        ...
        {activeSection === 'messages'      && <MessagesSection  messages={messages} loading={loadingMessages} people={people} isDemo={isDemo} planLimits={planLimits} onUpgrade={() => handleUpgrade('family', 'yearly')} addMessage={messagesHook.add} updateMessage={messagesHook.update} deleteMessage={messagesHook.remove} uploadVideo={messagesHook.uploadVideo} uploadMedia={messagesHook.uploadMedia} releaseExternal={messagesHook.releaseExternal} aiEnabled={aiEnabled} />}
