  ...
  return (
    <div className="rounded-[2rem] border border-stone-200 bg-white p-12 text-center space-y-3">
      ...
      <p className="text-stone-500 text-sm max-w-xs mx-auto leading-relaxed">
        This family has not granted you access to this section. They can change this at any time from their advisor access settings.
      </p>
    </div>
  )
}

// ── Advisor access tab (family-controlled permissions) ─────────
  ...
  return (
    <div className="rounded-[2rem] border border-stone-200 bg-white p-7 space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h3 className="font-semibold text-navy-900 text-base">Advisor access controls</h3>
      ...
      <Modal title="Family limit reached" onClose={onClose}>
        <div className="text-center space-y-4 py-2">
          ...
          <p className="text-sm text-stone-700 leading-relaxed">
            Your Advisor plan supports up to <strong>{familiesLimit} families</strong>. You have reached the limit.
          </p>
  ...
  return (
    <Modal title="Invite a family" onClose={onClose}>
      <p className="text-xs text-stone-500 mb-4 leading-relaxed">
        Invite someone you represent to create an Everstead plan. They will receive an email with instructions. You will be added as their Financial Advisor automatically once they accept.
      </p>
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-between gap-3 border border-stone-200 rounded-xl px-4 py-3 bg-navy-50">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-0.5">Covered by your Advisor subscription · no extra charge for your clients</p>
            </div>
...
function CancelPlanModal({ advisor, families, isDemo, onClose, onCancelled }) {
  ...
  if (step === 'review') {
    return (
      <Modal title="Cancel advisor plan" onClose={onClose}>
        <div className="space-y-4">
          <p className="text-sm text-stone-700 leading-relaxed">
          ...
          <div className="space-y-0">
            {[
              ...
              },
              {
                ...
                body: `An in-platform alert and email is sent to each of your ${acceptedFamilies.length} active client${acceptedFamilies.length !== 1 ? 's' : ''} telling them you are leaving Everstead and that your advisor access will be removed on the effective date.`,
              },
              {
                dot: 'bg-red-600',
                label: `${effectiveDate} — advisor access ends`,
                body: 'Your portal closes. Each linked family has 30 days to add a payment method and continue on their own plan. Your Financial Advisor entry is removed from each of their trusted people lists.',
              },
  ...
  if (step === 'reason') {
    return (
      <Modal title="Why are you cancelling?" onClose={onClose}>
        <div className="space-y-4">
          <p className="text-xs text-stone-500">Your feedback helps us improve Everstead for advisors.</p>
          <div className="space-y-2">
            {[
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl px-4 py-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-red-700 leading-relaxed">
                An alert will appear in the plan dashboard of each linked family, and an email will be sent to their registered address. Your advisor access ends on <strong>{effectiveDate}</strong>.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-stone-200 bg-stone-50 px-4 py-3 space-y-1.5">
            ...
            <div className="flex justify-between text-xs text-stone-700">
              <span>Advisor</span><span className="font-medium">{advisor.full_name}</span>
            </div>
            <div className="flex justify-between text-xs text-stone-700">
      ...
      <div className="text-center space-y-4 py-2">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-stone-600 leading-relaxed">
            All {acceptedFamilies.length} linked client{acceptedFamilies.length !== 1 ? 's have' : ' has'} been notified by in-platform alert and email. Your advisor access will remain active until <strong>{effectiveDate}</strong>.
          </p>
        </div>
...
const ADVISOR_GUIDES = [
  ...
  {
    icon: FileText,
    title: 'Documents advisors often reference',
    ...
    items: [
      ...
      { label: 'LPA — Property & Financial Affairs', detail: 'Knowing whether an LPA exists, and who holds it, is critical for clients with cognitive decline risk. If no LPA exists, the Court of Protection process is expensive and slow. Advisors are often the right people to prompt this.' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'The Probate Registry', detail: 'Apply for a Grant of Probate online at gov.uk/wills-probate-inheritance. For complex estates, direct advisors and executors to use a solicitor rather than a personal application.' },
    ],
  },
]
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-[2rem] border border-stone-200 bg-white p-6">
        <h2 className="text-base font-semibold text-navy-950 mb-1">Advisor resources</h2>
  ...
  return (
    <div className="max-w-2xl space-y-5">
      ...
      <div className="rounded-[2rem] border border-stone-200 bg-white p-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-base font-semibold text-navy-950">Advisor profile</h2>
    ...
    <div className="rounded-[2rem] border border-stone-200 bg-white p-8 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-stone-400 mt-0.5">Your Everstead Advisor subscription</p>
        </div>
      ...
      <div className={`rounded-2xl border p-5 space-y-4 ${cancelled ? 'border-red-200 bg-red-50' : 'border-navy-200 bg-navy-50'}`}>
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="font-semibold text-navy-950">Advisor plan</p>
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        {[
          ...
          { label: 'Member since', value: fmtBillingDate(advisor.plan_started_at), sub: 'Advisor plan', icon: CheckCircle2 },
    ...
    <div className="min-h-screen bg-stone-50 text-navy-950">
      {isDemo && (
        <div className="bg-amber-500 text-white text-xs font-semibold text-center py-2 px-4 flex items-center justify-center gap-3">
          <span>Demo mode — showing Sophie Carter's advisor portal. Data is fictional.</span>
      ...
      <header className="bg-navy-950 border-b border-navy-800">
        <div className="max-w-screen-2xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <span className="hidden sm:block text-xs font-semibold uppercase tracking-[0.18em] text-stone-400">Advisor Portal</span>
          </div>
          <div className="flex items-center gap-3">
