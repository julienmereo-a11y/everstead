// The ENGLISH homepage (Homepage v2). The French tree keeps the previous
// design in ./HomeFr.jsx; ../Home.jsx picks between them by language.
//
    ...
    <section className={`pt-24 lg:pt-28 bg-stone-50 ${SECTION_X}`}>
      <div className="max-w-[880px] mx-auto flex flex-col items-center gap-10">
        ...
        <div className="reveal w-full relative aspect-video rounded-[28px] overflow-hidden bg-navy-950 shadow-[0_48px_90px_-30px_rgba(13,22,40,0.45)]">
          {playing ? (
            <iframe
              src={`https://player.mux.com/${MUX_PLAYBACK_ID}?autoplay=true&accent-color=%232d5082&primary-color=%23fafaf9`}
            ...
            <>
              ...
              />
              <img
                src={`https://image.mux.com/${MUX_PLAYBACK_ID}/thumbnail.jpg?time=2&width=1600`}
                alt=""
                aria-hidden="true"
                loading="lazy"
    ...
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          contactPoint: [
            { '@type': 'ContactPoint', email: 'support@everstead.care', contactType: 'customer support', areaServed: 'GB', availableLanguage: 'English' },
            { '@type': 'ContactPoint', email: 'hello@everstead.care', contactType: 'sales', areaServed: 'GB', availableLanguage: 'English' },
          ],
